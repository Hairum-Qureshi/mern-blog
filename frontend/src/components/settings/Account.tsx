...
export default function Account() {
	...
	const { autoSave, saving, error, showSavingStatus, errorHandler, data } =
		useSettings();
...
// 	);
// 	const [email, setEmail] = useState<string | null>(userData && userData.email);
// 	const [biography, setBiography] = useState<string | null>(
// 		userData && userData.biography
// 	);
