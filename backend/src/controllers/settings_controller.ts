...
// TODO - create a helper function to handle similar logic!

const autosave = async (req: Request, res: Response) => {
	// TODO - When passing user ID to the database, make sure you check it's in the correct MongoDB ObjectID form!
