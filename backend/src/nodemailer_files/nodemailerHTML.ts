const ACCOUNT_VERIFICATION_HTML = (
	first_name: string,
	user_id: string,
	token: string,
	token_id: string
...
const PASSWORD_VERIFICATION_HTML = (
	first_name: string,
	user_id: string,
	uniqueToken: string,
	dbTokenID: string
...
<h4>
<div class="content">Hello ${first_name}, you are receiving this email to verify updating your account password. Click the link below to verify and have your password updated. <br /><br /> <a href="http://localhost:4000/api/user/verify/reset-password/${dbTokenID}?token=${uniqueToken}&uid=${user_id}" style="font-size: 17px; text-align: center;">This was me</a> <br /> <br /> If this was not you, please delete this email. This link will expire in 5 minutes.
    </h4>
</div>
</body>
</html>`;
...
export { ACCOUNT_VERIFICATION_HTML, PASSWORD_VERIFICATION_HTML };
